...
class AdminComposicionRazaController extends Controller
{
    ...
    public function create()
    {
        ...
        return view("admin.parametros.{$this->slug}.create", compact('catalog', 'tiposAnimal', 'fincas'));
    }
    ...
    public function show($id)
    {
        ...
        return view("admin.parametros.{$this->slug}.show", compact('catalog', 'item', 'fincaNombre', 'tipoAnimalNombre'));
    }
