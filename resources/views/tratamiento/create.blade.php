...
@section('title', 'Registrar nuevo tratamiento')
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="flex items-center space-x-4">
            ...
            <div>
                ...
                <p class="text-gray-500 text-sm mt-1">Prescribe e inicia un esquema terapéutico para un animal diagnosticado</p>
            </div>
        </div>
        <div>
    ...
    <form method="POST" action="{{ route('tratamiento.store') }}" novalidate class="space-y-6" id="tratamientoForm">
        @csrf
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-6">
                    <div class="border-b border-gray-100 pb-3">
                        ...
                        <p class="text-xs text-gray-500 mt-0.5">Filtra por finca o rebaño para localizar el diagnóstico clínico correspondiente</p>
                    </div>
                            ...
                            <select name="diagnostico_id" id="diagnostico_id"
                                ...
                                @foreach($diagnosticos as $diag)
                                    ...
                                    <option value="{{ $dId }}"
                                            ...
                                            {{ (string)old('diagnostico_id', request('diagnostico_id')) === (string)$dId ? 'selected' : '' }}>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="plan" id="plan" rows="3" maxlength="255"
                                      ...
                                      class="w-full px-4 py-3 border @error('plan') border-red-500 ring-2 ring-red-100 bg-red-50/30 @else border-gray-300 @enderror rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-ganaderasoft-celeste focus:border-transparent transition-all">{{ old('plan') }}</textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="date" name="fecha_ini" id="fecha_ini" required
                                       value="{{ old('fecha_ini', date('Y-m-d')) }}"
