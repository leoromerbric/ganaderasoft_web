...
@section('content')
    ...
    <div class="space-y-8">
        ...
        <div
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <div class="flex items-center space-x-2">
                            ...
                            <span
                                class="px-2.5 py-0.5 text-xs font-bold rounded-full bg-green-100 text-green-800 border border-green-200">
                                Finca Activa
                            </span>
                        </div>
                        <p class="text-sm text-gray-500 mt-0.5">Gestión integral de la unidad de producción #{{ $fincaId }}
                        </p>
                    </div>
                </div>
            </div>
            <div class="flex items-center space-x-3">
                <span
                    class="px-3.5 py-1.5 bg-ganaderasoft-celeste/15 text-ganaderasoft-azul border border-ganaderasoft-celeste/30 text-xs font-semibold rounded-full">
                    {{ $tipoExp }}
                </span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="{{ route('rebanos.index', ['finca_id' => $fincaId]) }}"
                class="group bg-white rounded-2xl shadow-sm p-6 hover:shadow-md transition-all duration-200 border-t-4 border-ganaderasoft-azul flex flex-col justify-between">
                <div>
                    <div class="flex items-center justify-between mb-4">
                        <div
                            class="w-14 h-14 rounded-xl bg-ganaderasoft-azul/10 flex items-center justify-center text-3xl group-hover:scale-105 transition-transform">
                            🐄
                        </div>
                    </div>
                ...
                <div
                    class="flex items-center text-ganaderasoft-azul font-semibold text-sm group-hover:text-ganaderasoft-celeste transition-colors pt-2">
            ...
            <a href="{{ route('animales.index', ['finca_id' => $fincaId]) }}"
                class="group bg-white rounded-2xl shadow-sm p-6 hover:shadow-md transition-all duration-200 border-t-4 border-ganaderasoft-celeste flex flex-col justify-between">
                <div>
                    <div class="flex items-center justify-between mb-4">
                        <div
                            class="w-14 h-14 rounded-xl bg-ganaderasoft-celeste/15 flex items-center justify-center text-3xl group-hover:scale-105 transition-transform">
                            📋
                        </div>
                    </div>
                ...
                <div
                    class="flex items-center text-ganaderasoft-celeste font-semibold text-sm group-hover:text-ganaderasoft-azul transition-colors pt-2">
            ...
            <a href="{{ route('personal-finca.index', ['finca_id' => $fincaId]) }}"
                class="group bg-white rounded-2xl shadow-sm p-6 hover:shadow-md transition-all duration-200 border-t-4 border-ganaderasoft-verde-oscuro flex flex-col justify-between">
                <div>
                    <div class="flex items-center justify-between mb-4">
                        <div
                            class="w-14 h-14 rounded-xl bg-ganaderasoft-verde/20 flex items-center justify-center text-3xl group-hover:scale-105 transition-transform">
                            👥
                        </div>
                    </div>
                ...
                <div
                    class="flex items-center text-ganaderasoft-verde-oscuro font-semibold text-sm group-hover:text-ganaderasoft-verde transition-colors pt-2">
