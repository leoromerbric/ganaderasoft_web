    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Actualice la información de la finca #{{ $fincaId }}</p>
            </div>
        ...
        <!-- Form Container -->
        <form method="POST" action="{{ route('fincas.update', $fincaId) }}"
            class="bg-white rounded-2xl shadow-sm p-8 border border-gray-100 space-y-8">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="Nombre" id="Nombre" required value="{{ old('Nombre', $nombreFinca) }}"
