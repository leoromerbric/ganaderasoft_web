...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Complete la información del trabajador de finca (API V2)</p>
        </div>
    ...
    <!-- Form Container -->
    <form method="POST" action="{{ route('personal.store') }}" class="bg-white rounded-2xl shadow-sm p-8 border border-gray-100 space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                <label class="block text-xs font-semibold text-gray-700 uppercase tracking-wider mb-2">Finca Asignada</label>
