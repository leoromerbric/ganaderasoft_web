...
@section('content')
    <div class="space-y-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            @foreach($kpis as $kpi)
                <div
                    class="bg-white rounded-2xl shadow-sm p-6 border-l-4 border-ganaderasoft-{{ $kpi['color'] }} hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
                    <div class="flex items-center justify-between">
                        ...
                        <div
                            class="w-14 h-14 rounded-xl bg-ganaderasoft-{{ $kpi['color'] }}/10 flex items-center justify-center text-3xl">
                            {{ $kpi['icon'] }}
                        </div>
                    </div>
                </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-center text-xs font-semibold text-gray-500 uppercase">Animales
                                    </th>
                                    <th class="px-4 py-3 text-center text-xs font-semibold text-gray-500 uppercase">Personal
                                    </th>
                                </tr>
                            </thead>
                                ...
                                @foreach($statistics['data']['fincas'] as $finca)
                                    ...
                                    <tr class="hover:bg-gray-50/80 transition-colors">
                                        ...
                                        <td class="px-4 py-3.5 text-center text-gray-700 font-semibold">
                                            {{ $finca['cantidad_rebanos'] ?? 0 }}</td>
                                        <td class="px-4 py-3.5 text-center text-gray-700 font-semibold">
                                            {{ $finca['cantidad_animales'] ?? 0 }}</td>
                                        <td class="px-4 py-3.5 text-center text-gray-700 font-semibold">
                                            {{ $finca['cantidad_personal'] ?? 0 }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
                        ...
                        <div class="overflow-x-auto rounded-xl border border-gray-100">
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase">Nombre</th>
                                        <th class="px-4 py-3 text-center text-xs font-semibold text-gray-500 uppercase">Finca ID
                                        </th>
                                        <th class="px-4 py-3 text-center text-xs font-semibold text-gray-500 uppercase">Animales
                                        </th>
                                    </tr>
