...
@section('title', 'Editar Histórico de Aplicación')
...
<div>
    <div class="mb-6 flex items-center">
        ...
        <h2 class="text-3xl font-bold text-ganaderasoft-negro">📋 Editar Histórico #{{ $historico['ha_id'] }}</h2>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-md">
        ...
        <form action="{{ route('historico-aplicacion.update', $historico['ha_id']) }}" method="POST" class="p-6">
            @csrf @method('PUT')
            @if($errors->any())
