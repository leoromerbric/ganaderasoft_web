...
<div class="space-y-8">
    ...
    <div class="flex flex-col min-[900px]:flex-row min-[900px]:items-center min-[900px]:justify-between gap-4">
        <div class="min-w-0">
            <h1 class="text-2xl sm:text-3xl font-bold text-ganaderasoft-negro tracking-tight">Medidas corporales</h1>
            <p class="text-gray-500 text-xs sm:text-sm mt-0.5 sm:mt-1">Evaluación biométrica, zoométrica y conformación morfológica del rebaño</p>
        </div>
