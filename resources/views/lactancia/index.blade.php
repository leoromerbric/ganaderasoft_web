                ...
                <table class="min-w-full divide-y divide-gray-200" id="tablaContenedor">
                    <thead class="bg-gray-50">
                        <tr class="flex justify-between items-center w-full">
                            ...
                            <th class="w-1/5 px-6 py-3.5 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Fecha inicio</th>
                            <th class="w-1/5 px-6 py-3.5 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Fecha fin / secado</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-100 text-sm" id="tablaLactancias">
                        ...
                        @endphp
                        <tr class="hover:bg-gray-50/80 transition-colors fila-lactancia flex justify-between items-center w-full"
