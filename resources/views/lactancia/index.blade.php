...
<div class="space-y-8">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-ganaderasoft-negro tracking-tight">Períodos de lactancia</h1>
            <p class="text-gray-500 text-xs sm:text-sm mt-0.5 sm:mt-1">Gestión, control y seguimiento de los ciclos de producción láctea del rebaño</p>
        </div>
