                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        @php
                            ...
                            $animalNombre = data_get($registro, 'animal.Nombre') ?? data_get($registro, 'animal.nombre') ?? ('Animal #'.$animalId);
                            $fecha = $registro['fecha'] ?? $registro['celo_fecha'] ?? null;
                            $observacion = $registro['observacion'] ?? $registro['celo_observacon'] ?? '-';
                            
                            $sexoVal = data_get($registro, 'animal.sexo') ?? data_get($registro, 'animal.Sexo') ?? 'H';
