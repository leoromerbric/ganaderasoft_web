...
<div class="overflow-hidden rounded-xl bg-white shadow-md">
    ...
    <form action="{{ route('vacunacion.store') }}" method="POST" class="space-y-6 p-6" id="vacunacionForm">
        ...
        <div class="rounded-lg border border-gray-200 bg-gray-50 p-4">
            ...
            <div class="mt-4">
                <p class="mb-2 text-xs text-gray-500">Desmarque los animales que no desea vacunar.</p>
                <div class="max-h-72 overflow-y-auto rounded-lg border border-gray-200 bg-white">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="sticky top-0 bg-gray-50">
                            <tr>
                                <th class="w-12 px-4 py-3 text-left">
                                    <input type="checkbox" id="check-all" class="rounded border-gray-300 text-ganaderasoft-verde focus:ring-ganaderasoft-verde" title="Marcar/Desmarcar todos">
                                </th>
                        ...
                        <tbody id="animales-lista" class="divide-y divide-gray-200 bg-white">
                            <tr><td colspan="4" class="px-4 py-4 text-center text-gray-400">Seleccione un rebaño y presione "Cargar animales".</td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
