...
<div class="space-y-8">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-ganaderasoft-negro tracking-tight">Movimientos de rebaño</h1>
            <p class="text-gray-500 text-xs sm:text-sm mt-0.5 sm:mt-1">Gestión y registro de traslados de animales entre fincas y rebaños</p>
        </div>
