...
<div class="space-y-8">
    ...
    <div class="flex flex-col min-[900px]:flex-row min-[900px]:items-center min-[900px]:justify-between gap-4">
        <div class="flex items-center space-x-3.5 sm:space-x-4 min-w-0">
            <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-ganaderasoft-celeste/15 text-ganaderasoft-azul flex items-center justify-center font-bold text-xl sm:text-2xl shadow-sm border border-ganaderasoft-celeste/20 shrink-0">
                📝
            </div>
            <div class="min-w-0">
                <h1 class="text-2xl sm:text-3xl font-bold text-ganaderasoft-negro tracking-tight">Cambios de animales</h1>
                <p class="text-gray-500 text-xs sm:text-sm mt-0.5 sm:mt-1">Monitoreo de desarrollo, transiciones de etapa y registros biométricos del rebaño</p>
            </div>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
            ...
            <!-- Botón Limpiar -->
            <div>
                <a href="javascript:void(0)" onclick="limpiarFiltros(event)"
