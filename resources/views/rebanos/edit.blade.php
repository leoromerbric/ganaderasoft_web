    ...
    <div class="max-w-2xl mx-auto space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm p-8 border border-gray-100 space-y-6">
            ...
            <form method="POST" action="{{ route('rebanos.update', $rebanoId) }}" class="space-y-6">
                ...
                @if($animalesCount > 0)
                    <div
                        class="p-4 bg-ganaderasoft-celeste/10 border border-ganaderasoft-celeste/20 rounded-xl text-xs space-y-2">
                        ...
                        <a href="{{ route('animales.index', ['rebano_id' => $rebanoId]) }}"
                            class="inline-block text-ganaderasoft-celeste hover:underline font-semibold">
