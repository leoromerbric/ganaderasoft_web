    ...
    <div class="flex flex-col min-[900px]:flex-row min-[900px]:items-center min-[900px]:justify-between gap-4">
        <div class="flex items-center space-x-3.5 sm:space-x-4 min-w-0">
            ...
            <div class="min-w-0">
                ...
                <p class="text-gray-500 text-xs sm:text-sm mt-0.5 sm:mt-1">Administración del inventario de ganado, genealogía y registro por rebaños y fincas</p>
            </div>
        </div>
        <div class="flex flex-col sm:flex-row items-center gap-2.5 sm:gap-3 w-full min-[900px]:w-auto shrink-0">
            <a href="{{ route('animales.importar', ['finca_id' => $idFinca]) }}"
               class="flex-1 w-full min-[900px]:flex-initial min-[900px]:w-auto px-5 sm:px-6 py-2.5 sm:py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-all duration-200 shadow-2xs font-medium text-sm sm:text-base flex items-center justify-center gap-2 text-center whitespace-nowrap shrink-0">
            ...
            <a href="{{ route('animales.create') }}"
               class="flex-1 w-full min-[900px]:flex-initial min-[900px]:w-auto px-5 sm:px-6 py-2.5 sm:py-3 bg-ganaderasoft-verde-oscuro text-white rounded-lg hover:bg-opacity-90 transition-all duration-200 shadow-md hover:shadow-lg font-medium text-sm sm:text-base flex items-center justify-center gap-2 text-center whitespace-nowrap shrink-0">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
        ...
        <div class="bg-white rounded-2xl p-4 sm:p-5 border border-gray-100 shadow-sm flex items-center justify-between">
            <div>
                ...
                <h3 class="text-xl sm:text-2xl font-black text-gray-900 mt-1" id="kpiTotal">{{ $estadisticas['total'] ?? count($animales) }}</h3>
        ...
        <div class="bg-white rounded-2xl p-4 sm:p-5 border border-gray-100 shadow-sm flex items-center justify-between">
            <div>
                ...
                <h3 class="text-xl sm:text-2xl font-black text-blue-700 mt-1" id="kpiMachos">{{ $estadisticas['machos'] ?? 0 }}</h3>
        ...
        <div class="bg-white rounded-2xl p-4 sm:p-5 border border-gray-100 shadow-sm flex items-center justify-between">
            <div>
                ...
                <h3 class="text-xl sm:text-2xl font-black text-pink-700 mt-1" id="kpiHembras">{{ $estadisticas['hembras'] ?? 0 }}</h3>
                <p class="text-[11px] text-gray-400 mt-0.5">Ejemplares hembras</p>
            </div>
            <div class="w-12 h-12 rounded-xl bg-pink-50 text-pink-600 flex items-center justify-center text-xl font-bold border border-pink-100 shadow-2xs shrink-0">
                🥛
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl p-4 sm:p-5 border border-gray-100 shadow-sm flex items-center justify-between">
            <div>
                ...
                <h3 class="text-xl sm:text-2xl font-black text-emerald-700 mt-1" id="kpiActivos">{{ $estadisticas['activos'] ?? count($animales) }}</h3>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4 items-end">
            ...
            <div>
                ...
                <select id="filtroArchivado"
                    ...
                    <option value="todos" {{ $estadoFiltro === 'todos' ? 'selected' : '' }}>Todos los animales</option>
                </select>
            </div>
