    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex flex-wrap items-center gap-3">
            <a href="{{ route('animales.show', $animal['id']) }}"
               class="px-5 py-2.5 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-xl transition-all duration-200 shadow-md hover:shadow-lg text-sm inline-flex items-center gap-2">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="flex items-center pt-2">
                            <label class="relative flex items-center p-3 rounded-xl border border-gray-200 hover:bg-gray-50 cursor-pointer w-full transition-colors">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div class="p-4 bg-emerald-50/60 border border-emerald-100 rounded-2xl flex items-center space-x-3">
                            ...
                            <div>
                                <p id="previewNombre" class="text-base font-bold text-gray-900">{{ $animal['nombre'] ?? 'Sin nombre' }}</p>
                        ...
                        <div class="space-y-3 text-xs text-gray-600 border-b border-gray-100 pb-4">
                            ...
                            <div class="flex justify-between">
                                <span>Rebaño:</span>
                                <span id="previewRebano" class="font-bold text-gray-900">
                                    {{ data_get($animal, 'rebano.nombre', 'No seleccionado') }}
                                </span>
                            </div>
                            <div class="flex justify-between">
                                <span>Raza:</span>
                                <span id="previewRaza" class="font-bold text-gray-900">
                                    {{ data_get($animal, 'composicion_raza.nombre', 'No seleccionada') }}
                                </span>
                            </div>
                            <div class="flex justify-between">
                                <span>Procedencia:</span>
                                <span id="previewProcedencia" class="font-semibold text-gray-900">
