...
@php
    ...
    $nombreEmp = $personaSub['nombre'] ?? $personalFinca['nombre'] ?? $personalFinca['Nombre'] ?? '';
    $apellidoEmp = $personaSub['apellido'] ?? $personalFinca['apellido'] ?? $personalFinca['Apellido'] ?? '';
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nombre" id="nombre" required 
                                   value="{{ old('nombre', $nombreEmp) }}" maxlength="25"
                        ...
                        <div>
                            ...
                            <input type="text" name="apellido" id="apellido" required 
                                   value="{{ old('apellido', $apellidoEmp) }}" maxlength="25"
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div class="p-4 bg-teal-50/70 border border-teal-100 rounded-2xl flex items-center space-x-3">
                            ...
                            <div class="overflow-hidden">
                                <p id="previewNombreCompleto" class="text-base font-bold text-gray-900 truncate">{{ trim($nombreEmp . ' ' . $apellidoEmp) ?: 'Personal #' . $pId }}</p>
                        ...
                        <div class="space-y-3 text-xs text-gray-600 border-b border-gray-100 pb-4">
                            ...
                            <div class="flex justify-between items-center gap-2">
                                ...
                                <span class="font-bold text-emerald-700 text-right">{{ $status ? '🟢 Activo' : '⚪ Inactivo' }}</span>
                            </div>
                            <div class="flex justify-between items-center gap-2">
