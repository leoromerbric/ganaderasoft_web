...
@section('content')
    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-0.5">{{ $tipoNombre }} • {{ $fincaNombre }}</p>
                </div>
            </div>
        ...
        @if(session('success'))
            <div
                class="p-4 bg-green-50 border-l-4 border-green-500 text-green-800 rounded-xl shadow-sm flex items-center space-x-2">
