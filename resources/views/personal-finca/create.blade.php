...
@section('title', 'Nuevo Personal de Finca - GanaderaSoft')
...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-3xl font-bold text-ganaderasoft-negro">👥 Nuevo Personal de Finca</h1>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md">
            ...
            <div class="bg-ganaderasoft-celeste text-white px-6 py-4 rounded-t-lg">
                <h2 class="text-lg font-semibold">Información del Personal</h2>
                <p class="text-sm opacity-90 mt-1">Complete los datos del nuevo personal de la finca</p>
            </div>

            <form action="{{ route('personal-finca.store') }}" method="POST" class="p-6">
                @csrf
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="Tipo_Trabajador" id="Tipo_Trabajador" 
                                ...
                                <option value="Vigilante" {{ old('Tipo_Trabajador') == 'Vigilante' ? 'selected' : '' }}>🛡️ Vigilante</option>
