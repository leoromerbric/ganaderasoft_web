...
<div>
    ...
    <div class="bg-white rounded-2xl shadow-sm p-6 border border-gray-100 mb-6">
        <form method="GET" action="{{ route('palpacion.index') }}">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Técnico</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        @php
                            ...
                            $sexoVal = data_get($palpacion, 'animal.sexo') ?? data_get($palpacion, 'animal.Sexo') ?? 'H';
                                ...
                                <div class="flex justify-center space-x-2">
                                    ...
                                    <form method="POST" action="{{ route('palpacion.destroy', $pId) }}" class="inline-block" id="form-delete-palpacion-{{ $pId }}">
                                        ...
                                        <button type="button" onclick="openGenericConfirmModal({
                                            ...
                                            message: '¿Estás seguro de que deseas eliminar este registro de palpación? Esta acción no se puede deshacer.',
