...
<div>
    <div class="mb-6 flex items-center">
        ...
        <h2 class="text-3xl font-bold text-ganaderasoft-negro">💉 Nueva Vacuna</h2>
    </div>

    <div class="bg-white rounded-xl shadow-md">
        <div class="bg-ganaderasoft-celeste text-white px-6 py-4 rounded-t-xl">
            <h3 class="text-lg font-semibold">Datos de la Vacuna</h3>
        </div>
        <form action="{{ route('vacuna.store') }}" method="POST" class="p-6">
            @csrf
            @if($errors->any())
