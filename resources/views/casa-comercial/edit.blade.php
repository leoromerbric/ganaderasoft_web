...
@section('title', 'Editar Casa Comercial')
        ...
        <form action="{{ route('casa-comercial.update', $casa['casa_id']) }}" method="POST" class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="laboratorio" maxlength="60" required
                           value="{{ old('laboratorio', $casa['laboratorio'] ?? '') }}"
                ...
                <div>
                    ...
                    <input type="text" name="marca_comercial" maxlength="60" required
                           value="{{ old('marca_comercial', $casa['marca_comercial'] ?? '') }}"
                              class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-ganaderasoft-celeste">
                ...
                <div class="md:col-span-2">
                    <label class="inline-flex items-center gap-2 text-sm font-medium text-gray-700">
                        ...
                        <input type="checkbox" name="activa" value="1" {{ old('activa', (int)($casa['activa'] ?? 1)) == 1 ? 'checked' : '' }}
