        ...
        <div class="flex justify-between items-center h-16">
            ...
            <a href="{{ $homeRoute }}" class="flex items-center space-x-3 group">
                ...
                <div>
                    ...
                    <p class="text-xs font-medium text-gray-500">Sistema de gestión de ganadería</p>
                </div>
            </a>
            ...
            <div class="flex items-center">
                <a href="{{ route('profile') }}" class="flex items-center space-x-3 transition-all duration-200 hover:opacity-85 group" title="Ver mi perfil">
                    <div class="relative flex-shrink-0">
                        ...
                        <span class="absolute -bottom-0.5 -right-0.5 w-3 h-3 {{ $statusDotColor }} border-2 border-white rounded-full" title="{{ $statusDotTitle }}"></span>
                    </div>
