                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        @php
                            ...
                            $sexoVal = data_get($reproduccion, 'animal.sexo') ?? data_get($reproduccion, 'animal.Sexo') ?? 'H';
                                ...
                                <div class="flex justify-center space-x-2">
                                    ...
                                    <form method="POST" action="{{ route('reproduccion-animal.destroy', $rId) }}" class="inline-block" id="form-delete-repro-{{ $rId }}">
                                        ...
                                        <button type="button" onclick="openGenericConfirmModal({
                                            ...
                                            intent: 'danger',
                                            title: 'Eliminar registro de reproducción',
                                            message: '¿Estás seguro de que deseas eliminar este registro reproductivo? Esta acción no se puede deshacer.',
