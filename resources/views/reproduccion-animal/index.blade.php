...
<div>
    ...
    <div class="bg-white rounded-xl shadow-md p-6 mb-6">
        <form method="GET" action="{{ route('reproduccion-animal.index') }}" class="flex flex-wrap gap-4 items-end">
            ...
            <a href="{{ route('reproduccion-animal.index') }}" class="px-4 py-2 border border-gray-300 text-gray-600 rounded-lg hover:bg-gray-50 transition-colors">
                Limpiar
            </a>
        </form>
    </div>
