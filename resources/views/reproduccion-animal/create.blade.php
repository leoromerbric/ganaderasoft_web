        ...
        <form action="{{ route('reproduccion-animal.store') }}" method="POST" class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="repro_etapa_etid" required
                           value="{{ old('repro_etapa_etid') }}" placeholder="ID de etapa activa del animal"
                           class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-ganaderasoft-celeste @error('repro_etapa_etid') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input type="text" name="repro_observacion" value="{{ old('repro_observacion') }}" maxlength="60"
                           ...
                           class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-ganaderasoft-celeste @error('repro_observacion') border-red-500 @enderror">
