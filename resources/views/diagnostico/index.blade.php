    ...
    <div class="flex flex-col min-[900px]:flex-row min-[900px]:items-center min-[900px]:justify-between gap-4">
        ...
        <div class="w-full min-[900px]:w-auto shrink-0">
            <a href="{{ route('diagnostico.create') }}"
               class="w-full min-[900px]:w-auto px-5 sm:px-6 py-2.5 sm:py-3 bg-ganaderasoft-verde-oscuro text-white rounded-xl hover:bg-opacity-90 transition-all duration-200 shadow-md hover:shadow-lg flex items-center justify-center font-medium text-sm sm:text-base gap-2 text-center whitespace-nowrap shrink-0">
                + Nuevo diagnóstico
            </a>
        </div>
    </div>
