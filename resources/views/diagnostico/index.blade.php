        ...
        <form method="GET" action="{{ route('diagnostico.index') }}">
            <div class="flex flex-nowrap gap-3 items-end">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <input type="text" name="tipo" value="{{ $tipo }}" maxlength="30" placeholder="Tipo de diagnostico..."
                ...
                <div class="flex-none flex gap-2">
                    ...
                    <a href="{{ route('diagnostico.index') }}" class="px-4 py-2 border border-gray-300 text-gray-600 rounded-lg hover:bg-gray-50 transition-colors">Limpiar</a>
                </div>
            </div>
        </form>
    </div>
