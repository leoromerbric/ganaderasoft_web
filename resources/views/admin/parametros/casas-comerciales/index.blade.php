                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3.5 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Marca comercial</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-100 text-sm">
                            @foreach($items as $item)
                                ...
                                <tr class="hover:bg-gray-50/80 transition-colors fila-registro"
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap font-medium text-gray-700">{{ $item['marca_comercial'] ?? 'N/A' }}</td>
<td class="px-6 py-4 whitespace-nowrap">
                                        @if($item['activa'] ?? true)
