...
<div class="space-y-6">
    ...
    <form method="POST" action="{{ route('admin.'.$catalog['slug'].'.update', $item['id']) }}" class="space-y-6">
        @csrf
        @method('PUT')
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div class="space-y-3 text-xs text-gray-600 border-b border-gray-100 pb-4">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span id="previewFinca" class="text-right font-medium {{ empty($item['finca_id']) ? 'text-blue-600' : 'text-ganaderasoft-azul' }}">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    fincaInput?.addEventListener('change', updatePreview);
