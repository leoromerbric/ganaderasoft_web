        ...
        <div class="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-end">
                <div>
                    ...
                    <input type="text" id="filtroBuscador" placeholder="Buscar por Nombre o Siglas..."
                        ...
                        <tbody class="bg-white divide-y divide-gray-100 text-sm">
                            @foreach($items as $item)
                                @php
                                    ...
                                    $siglas = $item['siglas'] ?? '';
                                    $searchable = strtolower($mainVal . ' ' . $siglas);
                                    $inicial = strtoupper(substr((string)$mainVal, 0, 1));
                                    if(empty($inicial)) $inicial = '#';
                                @endphp
                                <tr class="hover:bg-gray-50/80 transition-colors fila-registro flex justify-between items-center w-full"
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xs text-gray-500">{{ $siglas ? $siglas . ' • ' : '' }}ID: #{{ $item['id'] }}</p>
                                            </div>
                                        </div>
                                    </td>
