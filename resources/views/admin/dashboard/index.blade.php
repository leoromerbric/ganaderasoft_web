...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6">
        <!-- KPI: Total Usuarios -->
        <div class="bg-white p-5 sm:p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow flex items-center justify-between">
            <div>
                <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider">Total usuarios</p>
                <h3 class="text-2xl sm:text-3xl font-extrabold text-gray-900 mt-1">{{ number_format($kpis['total_users'] ?? 0) }}</h3>
            </div>
            <div class="w-12 h-12 rounded-xl bg-purple-50 text-purple-600 flex items-center justify-center text-xl shrink-0">👥</div>
        </div>
        ...
        <div class="bg-white p-5 sm:p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow flex items-center justify-between">
            <div>
                ...
                <h3 class="text-2xl sm:text-3xl font-extrabold text-gray-900 mt-1">{{ number_format($kpis['total_fincas'] ?? 0) }}</h3>
            </div>
            <div class="w-12 h-12 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center text-xl shrink-0">🏡</div>
        </div>
        ...
        <div class="bg-white p-5 sm:p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow flex items-center justify-between">
            <div>
                ...
                <h3 class="text-2xl sm:text-3xl font-extrabold text-gray-900 mt-1">{{ number_format($kpis['total_rebanos'] ?? 0) }}</h3>
            </div>
            <div class="w-12 h-12 rounded-xl bg-teal-50 text-teal-600 flex items-center justify-center text-xl shrink-0">🏷️</div>
        </div>
        ...
        <div class="bg-white p-5 sm:p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow flex items-center justify-between">
            <div>
                ...
                <h3 class="text-2xl sm:text-3xl font-extrabold text-gray-900 mt-1">{{ number_format($kpis['total_animales'] ?? 0) }}</h3>
            </div>
            <div class="w-12 h-12 rounded-xl bg-amber-50 text-amber-600 flex items-center justify-center text-xl shrink-0">🐄</div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="{{ route('admin.users.index') }}" class="inline-flex items-center gap-1.5 px-3.5 py-1.5 bg-white hover:bg-gray-50 text-gray-700 text-xs font-bold rounded-lg border border-gray-200 shadow-sm transition-all">
                    Ver todos
